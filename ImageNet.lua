...
function dl.loadImageNet(datapath, samplesize, trainpath, validpath, metapath, verbose)
   ...
   trainpath = trainpath or paths.concat(dl.DATA_PATH, 'ILSVRC2012_img_train')
   -- path to validation images
   validpath = validpath or paths.concat(dl.DATA_PATH, 'ILSVRC2012_img_val')
   -- path to meta data
   metapath = metapath or paths.concat(dl.DATA_PATH, 'metadata')
